...
function toggleInventoryFields() {
    ...
    // Hide all inventory fields
    document.querySelectorAll('.inventory-field').forEach(function(field) {
        field.classList.add('d-none');
    });
    
    // Show the selected inventory field
    if (selectedSize) {
        document.querySelector('.' + selectedSize + '-inventory').classList.remove('d-none');
    }
}
