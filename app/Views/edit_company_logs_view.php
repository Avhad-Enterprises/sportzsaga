...
<body>
    ...
    <div class="main-container d-flex flex-column align-items-center justify-content-center min-vh-100">
        <div class="pd-ltr-20 xs-pd-20-10 w-100">
            <div class="min-height-200px">
                <!-- Back Button (No Gap) -->
                <div class="w-100 mb-2">
                    <a href="<?= base_url() ?>company_view" class="px-2 d-inline-block">
                ...
                <div class="row w-100 justify-content-center">
                    <div class="col-md-9">
                        <div class="pd-20 card-box mb-30">
                            <h4 class="text-blue mb-30 text-center">Company Update Timeline</h4>
                            <div class="timeline">
                                    ...
                                    <?php foreach ($updates as $update): ?>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h5 class="card-title">Company Updated</h5>
                                                        <p class="card-text">
