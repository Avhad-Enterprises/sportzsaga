...
<body>
    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px d-flex flex-column align-items-center justify-content-center min-vh-100 w-100">
                <!-- Back Button (No Gap) -->
                <div class="w-100">
                    <a href="<?= base_url() ?>profile" class="px-2 d-inline-block">
                ...
                <div class="row w-100 justify-content-center">
                    <div class="col-md-9">
                        <div class="pd-20 card-box mb-30">
                            <h4 class="text-blue mb-30 text-center">profile Update Timeline</h4>
                            <div class="timeline">
