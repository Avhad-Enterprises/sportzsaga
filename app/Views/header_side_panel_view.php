                    ...
                    <div class="mobilemenu-language">
                        ...
                        <div class="dropdn_language">
                            <div class="dropdn dropdn_language dropdn_language--noimg dropdn_caret">
                                ...
                                <div class="dropdn-content">
                                    <ul>
                                        <li class="active"><a href="#"><img src="<?= base_url() ?>admin-assets/images/flags/en.png" alt="">English</a></li>
                                        <li><a href="#"><img src="<?= base_url() ?>admin-assets/images/flags/sp.png" alt="">Spanish</a></li>
                                        <li><a href="#"><img src="<?= base_url() ?>admin-assets/images/flags/de.png" alt="">German</a></li>
                                        <li><a href="#"><img src="<?= base_url() ?>admin-assets/images/flags/fr.png" alt="">French</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="minicart-drop-content js-dropdn-content-scroll">
                <div class="minicart-prd row">
                    <div class="minicart-prd-image image-hover-scale-circle col">
                        <a href="product.html"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?= base_url() ?>admin-assets/images/skins/fashion/products/product-01-1.jpg" alt=""></a>
                    </div>
                ...
                <div class="minicart-prd row">
                    <div class="minicart-prd-image image-hover-scale-circle col">
                        <a href="product.html"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?= base_url() ?>admin-assets/images/skins/fashion/products/product-16-1.jpg" alt=""></a>
                    </div>
                    <div class="minicart-prd-info col">
                        <div class="minicart-prd-tag">FOXic</div>
