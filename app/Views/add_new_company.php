    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="d-flex justify-content-between align-items-center mb-4"> <!-- Added mb-4 for spacing -->
                ...
                <div class="pd-20 card-box mb-30">
                    <form id="add_company_form" method="post" action="<?= base_url('company/save_company') ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="company_name" name="company_name" type="text"
                                placeholder="Enter catalog name" value="<?= old('company_name') ?>" required>
                            ...
                            <div class="d-flex align-items-center mb-20">
                                ...
                                <select id="product-tags" name="product-tags[]" multiple="multiple"
                                    ...
                                    <?php foreach ($tags as $tag): ?>
                                        <option value="<?= $tag['tag_name']; ?>" <?= !empty($company['product-tags']) && in_array($tag['tag_name'], explode(',', $company['product-tags'])) ? 'selected' : '' ?>>
                                            <?= $tag['tag_name']; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <!--     <div class="form-group">
                            ...
                            <input class="form-control" id="time_line" name="time_line" type="date"
                                value="<?= old('time_line') ?>" required>
                            <div class="text-danger mt-1" id="time_line_error"></div>
                        </div> -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="street" name="street"
                                placeholder="Enter street address" value="<?= old('street') ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="apply_for_credit" name="apply_for_credit" required>
                                <option value="yes" <?= old('apply_for_credit') === 'yes' ? 'selected' : '' ?>>Yes</option>
                                <option value="no" <?= old('apply_for_credit') === 'no' ? 'selected' : '' ?>>No</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="registration_number" name="registration_number" type="text"
                                placeholder="Enter registration number" value="<?= old('registration_number') ?>">
                        ...
                        <!--<div class="form-group">
                            ...
                            <input class="form-control" id="principal_director" name="principal_director" type="text"
                                placeholder="Enter your role" value="<?= old('principal_director') ?>">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg">Save Company</button>
