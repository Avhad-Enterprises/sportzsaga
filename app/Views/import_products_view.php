                ...
                <div class="pd-20 card-box mb-30">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 text-right blogs-imex">
                            <div class="">
                                <a href="<?= base_url('download-file') ?>" class="download-btn" download>
                    ...
                    <form id="importexcelform" method="post" action="<?= base_url('admin-products/importexceldata') ?>" enctype="multipart/form-data">
                        <div class="main-img-box">
                            <div class="img-box">
                                <div class="form-group">
                                    <label></label>
                                    <input type="file" name="product_excel_file" accept=".xlsx, .xls">
                                </div>
