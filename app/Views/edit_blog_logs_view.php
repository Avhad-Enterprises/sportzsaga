    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <!-- Back Button -->
                <div class="mb-3">
                    <a href="<?= base_url() ?>admin_blogs" class="px-2">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-9">
                        <div class="pd-20 card-box mb-30">
                            <h4 class="text-blue mb-30 text-center">Blog Update Timeline</h4>
                            <div class="timeline">
                                <?php if (!empty($updates)): ?>
                                    <?php foreach ($updates as $update): ?>
                                        <?php if (!isset($update['updated_at']) || !isset($update['updated_by'])) continue; ?> <!-- Skip invalid logs -->

                                        <div class="timeline-item mb-3"> <!-- Added margin for better spacing -->
                                            ...
                                            <div class="timeline-content">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h5 class="card-title">Blog Updated</h5>
                                                        <p class="card-text">
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <p class="text-center">No updates found.</p> <!-- Centered for better presentation -->
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
