                ...
                <form id="newcollectionsview" method="post" action="<?= base_url('publishcollection') ?>"
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="pd-20 card-box mb-30">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="collection-name" required>
                        ...
                        <div class="col">
                            <div class="pd-20 card-box mb-30">
                                ...
                                <div class="form-group">
                                    <div id="Visibile" class="custom-control col custom-radio mb-5">
                                        <input type="radio" id="visibile" name="visibility" class="custom-control-input"
                                            value="visibile">
                                        <label class="custom-control-label" for="visibile">Visibile</label>
                                    </div>
                                    <div id="Hidden" class="custom-control col custom-radio mb-5">
                                        <input type="radio" id="hidden" name="visibility" class="custom-control-input"
                                            value="hidden">
                            ...
                            <div class="pd-20 card-box mb-30">
                                <p class="text-blue mb-3">Collouts</p>
                                <div class="card card-body">

                                    <div class="form-group">
                                        <label for="collout_title">Collout Title</label>
                                        <input type="text" name="collout_title" class="form-control" id="collout_title"
                                            required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    ...
                                    <!-- Image Preview -->
                                    <div class="mt-3">
                                        <img id="collout_image_preview" src="#" alt="Image Preview"
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        window.location.href = `${baseUrl}editcollections/${response.collection_id}`;
                    } else {
...
<script>
    document.getElementById('collout_image').addEventListener('change', function(event) {
        let file = event.target.files[0]; // Get selected file
        if (file) {
            let reader = new FileReader();
            reader.onload = function(e) {
                let preview = document.getElementById('collout_image_preview');
