        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Deleted Purchase Order</h4>
                    </div>
                    <div class="pb-20">
                        <table class="table hover data-table-export table-hover">
                            ...
                            <tbody>
                                <?php if (!empty($tiers2)): ?>
                                    <?php foreach ($tiers2 as $tier): ?>
                                        <tr>
                                            <td><?= esc($tier['tier_value']) ?></td>
                                            <td><?= esc($tier['tier_name']) ?></td>
                                            <td><?= esc($tier['tier_2_link']) ?></td>
                                            <td><?= esc($tier['deleted_at'] ?? 'N/A') ?></td>
                                            <td><?= esc($tier['deleted_by'] ?? 'N/A') ?></td>
                                            <td>
                                                <a class="dropdown-item" href="javascript:void(0);"
                                                    onclick="confirmTier2Restore(<?= esc($tier['tier_2_id']) ?>)">
