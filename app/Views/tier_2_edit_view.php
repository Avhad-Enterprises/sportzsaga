                ...
                <div class="pd-20 card-box mb-30">
                    <?php foreach ($tier_2 as $tier): ?>
                        <form id="edittierform" method="post"
                            action="<?= base_url('tiers/update_tier_2/' . $tier['tier_2_id']) ?>"
                            enctype="multipart/form-data" class="needs-validation" novalidate>
                            <input type="hidden" name="tier_1_id" value="<?= $tier['tier_1_id'] ?>">

                            <div class="d-flex justify-content-end">
                                <a href="<?= base_url() ?>tiers/logs_tier2/<?= $tier['tier_2_id'] ?>"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control" id="link" name="tier_link"
                                        value="<?= $tier['tier_2_link'] ?>" placeholder="Link" readonly required>
                                    <div class="valid-feedback">Looks good!</div>
                                    <div class="invalid-feedback">This field can't be Empty</div>
                                </div>
                            </div>
