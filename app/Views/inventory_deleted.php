                            ...
                            <tbody>
                                <?php if (!empty($inventory)): ?>
                                    <?php foreach ($inventory as $inven): ?>
                                        <tr>
                                            <td><?= esc($inven['stock_quantity']) ?></td>
                                            <td><?= esc($inven['reorder_level']) ?></td>
                                            <td><?= esc($inven['safety_stock']) ?></td>
                                            <td><?= esc($inven['deleted_at'] ?? 'N/A') ?></td>
                                            <td><?= esc($inven['deleted_by'] ?? 'N/A') ?></td>
                                            <td>
                                                <a class="dropdown-item" href="javascript:void(0);"
                                                    onclick="confirmInventoryRestore(<?= esc($inven['id']) ?>)">
