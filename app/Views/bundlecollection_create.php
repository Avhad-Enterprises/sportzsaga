        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-blue h4">Add New Product-Collection</h4>
                            <p class="mb-30">Create a New Product-Collection</p>
                        </div>
                    </div>

                    <form id="addbundleform" method="post" action="<?= base_url() ?>bundlecontroller/createcollection"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm">
                                ...
                                <input class="form-control" name="selling_price" type="number" placeholder="Bundle Price">                               
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm">
                                ...
                                <select class="form-control select2" name="selected_products" id="selected_products" required>
                        ...
                        <div class="form-group row">
                            <div class="col-sm">
                                ...
                                <select class="form-control select2" name="selected_collection[]" id="selected_collection" multiple>
                        ...
                        <div class="form-group row">
                            <div class="col-sm">
                                ...
                                <input class="form-control" type="number" name="quantity" placeholder="Enter Quantity" min="1">
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Ensure selling price is read-only
        sellingPriceField.readOnly = true;

        // Function to calculate the price based on the selected product
        const calculatePrice = () => {
            const selectedOption = selectedProducts.selectedOptions[0]; // Get the selected option
        ...
        selectedProducts.addEventListener('change', calculatePrice);

        // Handle Select2 change event
        $('.select2').on('change', calculatePrice);
