                ...
                <div class="col-lg col-xl last-mobile">
                    <div class="footer-block">
                        <div class="footer-logo">
                            <a href="index.html"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="<?= base_url() ?>admin-assets/images/logo-footer.png 1x, <?= base_url() ?>admin-assets/images/logo-footer2x.png 2x" alt="Logo"></a>
                        </div>
