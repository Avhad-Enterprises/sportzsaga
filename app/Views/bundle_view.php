        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="page-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 text-right blogs-imex">
                            <div class="dropdown">
                                <a class="btn btn-primary fw-bold" href="<?= base_url(); ?>bundle_create" role="button">
                                    Add New
                                </a>
                            </div>
                            <div class="dropdown">
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Registered Bundles</h4>
                    </div>
                    <div class="pb-20">
                        <table id="datatable-responsive" class="table hover multiple-select-row data-table-export"
                            ...
                            <tbody>
                                <?php foreach ($bundles as $bundle): ?>
                                    <tr>
                                        <td class="table-plus"><?= esc($bundle['bundle_id']) ?></td>
                                        <td><?= esc($bundle['bundle_name']) ?></td>
                                        <td>
                                            <?php if (!empty($bundle['product_titles'])): ?>
                                                <?php
                                                // Split product titles by comma and display each one
                                                $products = explode(',', $bundle['product_titles']);
                                        ...
                                        <td><?= esc($bundle['bundle_price']) ?></td>
                                        <td>
                                            <?= $bundle['discount_type'] === 'percent'
                                                ? esc($bundle['discount_value']) . '%'
                                                : '$' . esc($bundle['discount_value']) ?>
                                        </td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    ...
                                                    <?php if ($canDelete): ?>
                                                        <a class="dropdown-item" href="javascript:void(0);"
                                                            onclick="confirmBundleDelete(<?= $bundle['bundle_id'] ?>)">
