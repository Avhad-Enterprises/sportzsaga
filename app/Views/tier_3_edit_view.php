            ...
            <div class="min-height-200px">
                ...
                <div class="clearfix mb-3">
                    <div class="pull-left d-flex align-items-center">
                        ...
                        <h4 class="h4 mb-0">Add Tier 3</h4>
                    </div>
                </div>

                </div>
                <div class="pd-20 card-box mb-30">
                    <?php foreach ($tier_3 as $tier) : ?>
                        <form id="edittierform" method="post" action="<?= base_url('tiers/update_tier_3/' . $tier['tier_3_id']) ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <input type="hidden" name="tier_2_id" value="<?= $tier['tier_2_id'] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="text" class="form-control" id="link" name="tier_link" value="<?= $tier['tier_3_link'] ?>" placeholder="Link" readonly required>
                                    <div class="valid-feedback">Looks good!</div>
                                    <div class="invalid-feedback">This field can't be Empty</div>
                                </div>
                            </div>
