    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="w-100">
                    <a href="<?= base_url() ?>inventory_list_view" class="px-2 d-inline-block">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="pd-20 card-box mb-30">
                            <h4 class="text-blue mb-30">Inventory Update Timeline</h4>
                            <div class="timeline">
                                    ...
                                    <?php foreach (array_reverse($updates) as $update): ?> <!-- Reverse array order -->
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h5 class="card-title">Inventory Updated</h5>
                                                        <p class="card-text">
