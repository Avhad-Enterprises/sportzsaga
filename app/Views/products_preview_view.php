<!-- Head Start -->
<?= $this->include('fhead_view'); ?>
<!-- Head End -->

<body class="has-smround-btns has-loader-bg equal-height">

    <div class="triangle-top-left">
        <span class="triangle-text">Preview</span>
    </div>

    <!--header-->
    <?= $this->include('fheader_view'); ?>
    <!--header end-->
                ...
                <div class="holder breadcrumbs-wrap mt-0">
                    <div class="container">
                        <ul class="breadcrumbs">
                            ...
                            <li><span><?= esc($product['product_title']) ?></span></li>
                        </ul>
                    </div>
                </div>
                <div class="holder">
                                ...
                                <div class="js-prd-d-holder">
                                    <div class="prd-block_title-wrap">
                                        <div class="prd-block_reviews" data-toggle="tooltip" data-placement="top"
                                            ...
                                            <span class="reviews-link"><a href="#" class="js-reviews-link"> (17
                                                    reviews)</a></span>
                                        </div>
                                        <h1 class="prd-block_title"><?= esc($product['product_title']) ?></h1>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-auto prd-block-prevnext-wrap">
                                <div class="prd-block-prevnext">
                                    <a href="#"><span class="prd-img"><img class="lazyload fade-up"
                                                ...
                                                data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-02-1.jpg" alt=""><i
                                                class="icon-arrow-left"></i></span></a>
                                    <a href="#"><span class="prd-img"><img class="lazyload fade-up"
                                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-01-1.jpg" alt=""></span></a>
                                    <a href="#"><span class="prd-img"><img class="lazyload fade-up"
                                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-15-1.jpg" alt=""><i
                                    ...
                                    <div class="prd-block_main-image">
                                        <div class="prd-block_main-image-holder" id="prdMainImage">
                                            <div class="product-main-carousel js-product-main-carousel"
                                                ...
                                                <div data-value="<?= esc($product['product_title']) ?>">
                                                    <span class="prd-img">
                                                        <img src="<?= $product['product_image'] ?>"
                                                            data-src="<?= $product['product_image'] ?>"
                                                            class="lazyload fade-up elzoom" alt="<?= esc($product['product_title']) ?>"
                                                ...
                                                <?php if (!empty($product['more_images'])): ?>
                                                    ...
                                                    $moreImages = json_decode($product['more_images'], true);
                                                    ?>
                                                    <?php if (is_array($moreImages) && count($moreImages) > 0): ?>
                                                        <?php foreach ($moreImages as $image): ?>
                                                            <div data-value="<?= esc($product['product_title']) ?>">
                                                                <span class="prd-img">
                                                                    <img src="<?= esc($image) ?>"
                                                                        data-src="<?= esc($image) ?>"
                                                                        class="lazyload fade-up elzoom" alt="<?= esc($product['product_title']) ?>"
                                                                        data-zoom-image="<?= esc($image) ?>" />
                                                                </span>
                                                            </div>
                                                        <?php endforeach; ?>
                                                    <?php else: ?>
                                        ...
                                        <div class="prd-block_main-image-links">
                                            ...
                                            <a href="<?= base_url() ?>assets/images/products//product-01.jpg" class="prd-block_zoom-link"><i
                                                    class="icon-zoom-in"></i></a>
                                        </div>
                                    </div>
                                    <div class="product-previews-wrapper">
                                        <div class="product-previews-carousel js-product-previews-carousel">
                                            <a href="#" data-value="<?= esc($product['product_title']) ?>"><span class="prd-img"><img
                                                        src="<?= $product['product_image'] ?>"
                                                        data-src="<?= $product['product_image'] ?>"
                                                        class="lazyload fade-up" alt="<?= esc($product['product_title']) ?>" /></span></a>
                                            ...
                                            <?php if (!empty($product['more_images'])): ?>
                                                ...
                                                <?php if (is_array($moreImages) && count($moreImages) > 0): ?>
                                                    <?php foreach ($moreImages as $image): ?>
                                                        <a href="#" data-value="<?= esc($product['product_title']) ?>">
                                                            <span class="prd-img">
                                                                <img src="<?= esc($image) ?>"
                                                                    data-src="<?= esc($image) ?>"
                            ...
                            <div class="col-md-10 col-lg-10 col-xl-10 mt-1 mt-md-0">
                                <div class="prd-block_info prd-block_info--style1"
                                    ...
                                    <div class="prd-block_description prd-block_info_item ">
                                        <div class="EmiMainContainer d-flex">
                                            <div><b>EMI</b></div>
                                            <div>Starts at ₹630.28/month</div>
                                            <a href="#"> Know More </a>
                                    ...
                                    <div class="prd-progress prd-block_info_item" data-left-in-stock="">
                                        <?php if ($product['inventory'] < 30): ?>
                                            <div class="prd-progress-text"
                                                style="<?= $product['inventory'] < 10 ? 'color: red;' : '' ?>">
                                                Hurry Up! Left <span class="prd-progress-text-left js-stock-left"><?= $product['inventory'] ?></span> in stock
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="order-0 order-md-100">
                                            ...
                                            <div class="prd-block_actions prd-block_actions--wishlist">
                                                ...
                                                <div class="btn-wrap">
                                                    <button class="btn btn--add-to-cart js-trigger-addtocart js-prd-addtocart"
                                                        data-product='{"name":  "<?= esc($product['product_id']) ?>",  "url ": "<?= base_url() ?>products/<?= esc($product['url']) ?>",  "path ": "<?= base_url() ?>assets/images/skins/fashion/product-page/product-01.jpg",  "aspect_ratio ": "0.78"}'>Add
                                                        to cart</button>
                                                </div>
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('.js-trigger-addtocart').on('click', function() {
                                                    const productId = $(this).data('product-id');
                                                    const quantity = $('#addToCartForm .qty-input').val();
                                            ...
                                            $(document).ready(function() {
                                                const guestCart = JSON.parse(getCookie("guest_cart") || "[]");
                ...
                <div class="holder mt-3 mt-md-5">
                    <div class="container">
                        ...
                        <ul class="nav nav-tabs product-tab">
                            ...
                            <li class="nav-item"><a href="#Tab2" class="nav-link" data-toggle="tab">FAQ's
                                    <span class="toggle-arrow"><span></span><span></span></span>
                                </a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade" id="Tab1">
                                <h4 class="mb-15">Full Description</h4>
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-12">
                                        <p>Nor again is there anyone who loves or pursues or desires to obtain pain of itself,
                                            ...
                                            pain can procure him some great pleasure. Nor again is there anyone who loves or
                                            pursues.</p>
                                        <div class="mt-2"></div>
                                        <h4>List heading</h4>
                                        <div class="row">
                                    ...
                                    <div class="col-md-6"><img
                                            src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                            data-src="<?= base_url() ?>assets/images/product-description-02.png" alt="" class="lazyload"></div> -->
                                </div>
                                <!-- <div class="row mt-2 align-items-center">
                                    <div class="col-md-6"><img
                                            src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                            data-src="<?= base_url() ?>assets/images/product-description-01.png" alt="" class="lazyload"></div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="faq-item-wrap">
                                            <div class="faq-item">
                                                ...
                                                <div class="faq-item-content">
                                                    <p>We will do everything we can to get your parcel to its destination as soon as
                                                        possible. In central London, we can even arrange a same day courier...</p>
                                                </div>
                                            </div>
                                            <div class="faq-item">
                                    ...
                                    <div class="prd-img-area">
                                        <a href="product.html" class="prd-img image-hover-scale image-container">
                                            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-06-1.jpg"
                                        ...
                                        <div class="prd-circle-labels">
                                            ...
                                            <div class="colorswatch-label colorswatch-label--variants js-prd-colorswatch">
                                                <i class="icon-palette"><span class="path1"></span><span
                                                        ...
                                                        class="path10"></span></i>
                                                <ul>
                                                    <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-06-1.jpg"><a
                                                            class="js-color-toggle" data-toggle="tooltip" data-placement="left"
                                                            title="Color Name"><img src="<?= base_url() ?>assets/images/colorswatch/color-grey.png"
                                                                alt=""></a></li>
                                                    <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-06-color-2.jpg"><a
                                                            class="js-color-toggle" data-toggle="tooltip" data-placement="left"
                                                            title="Color Name"><img src="<?= base_url() ?>assets/images/colorswatch/color-green.png"
                                                                alt=""></a></li>
                                                    <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-06-color-3.jpg"><a
                                                            class="js-color-toggle" data-toggle="tooltip" data-placement="left"
                                                            title="Color Name"><img src="<?= base_url() ?>assets/images/colorswatch/color-black.png"
                                                                alt=""></a></li>
                                                </ul>
                                            </div>
                                        ...
                                        <ul class="list-options color-swatch">
                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-06-1.jpg" class="active"><a
                                            ...
                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-06-2.jpg"><a href="#"
                                                    class="js-color-toggle" data-toggle="tooltip" data-placement="right"
                                                    title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-06-2.jpg"
                                                        class="lazyload fade-up" alt="Color Name"></a></li>


                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-06-3.jpg"><a href="#"
                                                    class="js-color-toggle" data-toggle="tooltip" data-placement="right"
                                                    title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-06-3.jpg"
                                                        class="lazyload fade-up" alt="Color Name"></a></li>
                                            ...
                                            <div class="prd-action">
                                                <form action="#">
                                                    <button class="btn js-prd-addtocart"
                                                        data-product='{"name": "Midi Dress with Belt", "path":"<?= base_url() ?>assets/images/skins/fashion/products/product-06-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add
                                                        To Cart</button>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <div class="prd prd--style2 prd-labels--max prd-labels-shadow ">
                                <div class="prd-inside">
                                    <div class="prd-img-area">
                                        <a href="product.html" class="prd-img image-hover-scale image-container">
                                            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-17-1.jpg"
                                        ...
                                        <ul class="list-options color-swatch">
                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-17-1.jpg" class="active"><a
                                                    href="#" class="js-color-toggle" data-toggle="tooltip"
                                                    data-placement="right" title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-17-1.jpg"
                                            ...
                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-17-2.jpg"><a href="#"
                                                    class="js-color-toggle" data-toggle="tooltip" data-placement="right"
                                                    title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-17-2.jpg"
                                                        class="lazyload fade-up" alt="Color Name"></a></li>


                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-17-3.jpg"><a href="#"
                                                    class="js-color-toggle" data-toggle="tooltip" data-placement="right"
                                                    title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-17-3.jpg"
                                                        class="lazyload fade-up" alt="Color Name"></a></li>
                                    ...
                                    <div class="prd-info">
                                        <div class="prd-info-wrap">
                                            ...
                                            <div class="prd-action">
                                                <form action="#">
                                                    <button class="btn js-prd-addtocart"
                                                        data-product='{"name": "Stand Collar Shirt", "path":"<?= base_url() ?>assets/images/skins/fashion/products/product-17-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add
                                                        To Cart</button>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <div class="prd prd--style2 prd-labels--max prd-labels-shadow ">
                                <div class="prd-inside">
                                    <div class="prd-img-area">
                                        <a href="product.html" class="prd-img image-hover-scale image-container">
                                            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-21-1.jpg"
                                        ...
                                        <ul class="list-options color-swatch">
                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-21-1.jpg" class="active"><a
                                                    href="#" class="js-color-toggle" data-toggle="tooltip"
                                                    data-placement="right" title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-21-1.jpg"
                                            ...
                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-21-2.jpg"><a href="#"
                                                    class="js-color-toggle" data-toggle="tooltip" data-placement="right"
                                                    title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-21-2.jpg"
                                                        class="lazyload fade-up" alt="Color Name"></a></li>


                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-21-3.jpg"><a href="#"
                                                    class="js-color-toggle" data-toggle="tooltip" data-placement="right"
                                                    title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-21-3.jpg"
                                                        class="lazyload fade-up" alt="Color Name"></a></li>
                                    ...
                                    <div class="prd-info">
                                        <div class="prd-info-wrap">
                                            ...
                                            <div class="prd-action">
                                                <form action="#">
                                                    <button class="btn js-prd-addtocart"
                                                        data-product='{"name": "Genuine Leather Strap Watch", "path":"<?= base_url() ?>assets/images/skins/fashion/products/product-21-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add
                                                        To Cart</button>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <div class="prd prd--style2 prd-labels--max prd-labels-shadow ">
                                <div class="prd-inside">
                                    <div class="prd-img-area">
                                        <a href="product.html" class="prd-img image-hover-scale image-container">
                                            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-26-1.jpg"
                                        ...
                                        <ul class="list-options color-swatch">
                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-26-1.jpg" class="active"><a
                                                    href="#" class="js-color-toggle" data-toggle="tooltip"
                                                    data-placement="right" title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-26-1.jpg"
                                            ...
                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-26-2.jpg"><a href="#"
                                                    class="js-color-toggle" data-toggle="tooltip" data-placement="right"
                                                    title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-26-2.jpg"
                                                        class="lazyload fade-up" alt="Color Name"></a></li>


                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-26-3.jpg"><a href="#"
                                                    class="js-color-toggle" data-toggle="tooltip" data-placement="right"
                                                    title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-26-3.jpg"
                                                        class="lazyload fade-up" alt="Color Name"></a></li>
                                    ...
                                    <div class="prd-info">
                                        <div class="prd-info-wrap">
                                            ...
                                            <div class="prd-action">
                                                <form action="#">
                                                    <button class="btn js-prd-addtocart"
                                                        data-product='{"name": "Pureboost Running Shoes", "path":"<?= base_url() ?>assets/images/skins/fashion/products/product-26-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add
                                                        To Cart</button>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <div class="prd prd--style2 prd-labels--max prd-labels-shadow ">
                                <div class="prd-inside">
                                    <div class="prd-img-area">
                                        <a href="product.html" class="prd-img image-hover-scale image-container">
                                            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-30-1.jpg"
                                        ...
                                        <ul class="list-options color-swatch">
                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-30-1.jpg" class="active"><a
                                                    href="#" class="js-color-toggle" data-toggle="tooltip"
                                                    data-placement="right" title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-30-1.jpg"
                                            ...
                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-30-2.jpg"><a href="#"
                                                    class="js-color-toggle" data-toggle="tooltip" data-placement="right"
                                                    title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-30-2.jpg"
                                                        class="lazyload fade-up" alt="Color Name"></a></li>


                                            <li data-image="<?= base_url() ?>assets/images/skins/fashion/products/product-30-3.jpg"><a href="#"
                                                    class="js-color-toggle" data-toggle="tooltip" data-placement="right"
                                                    title="Color Name"><img
                                                        src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                                        data-src="<?= base_url() ?>assets/images/skins/fashion/products/product-30-3.jpg"
                                                        class="lazyload fade-up" alt="Color Name"></a></li>
                                    ...
                                    <div class="prd-info">
                                        <div class="prd-info-wrap">
                                            ...
                                            <div class="prd-action">
                                                <form action="#">
                                                    <button class="btn js-prd-addtocart"
                                                        data-product='{"name": "Multiple Pocket Waist Pack", "path":"<?= base_url() ?>assets/images/skins/fashion/products/product-30-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add
                                                        To Cart</button>
                                                </form>
                                            </div>
                                        </div>
