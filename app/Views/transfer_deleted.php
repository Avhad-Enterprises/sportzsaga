                            ...
                            <tbody>
                                <?php if (!empty($transfers)): ?>
                                    <?php foreach ($transfers as $transfer): ?>
                                        <tr>
                                            <td><?= esc($transfer['giver']) ?></td>
                                            <td><?= esc($transfer['receiver']) ?></td>
                                            <td><?= esc($transfer['transfer_order_number']) ?></td>
                                            <td><?= esc($transfer['deleted_at'] ?? 'N/A') ?></td>
                                            <td><?= esc($transfer['deleted_by'] ?? 'N/A') ?></td>
                                            <td>
                                                <a class="dropdown-item" href="javascript:void(0);"
                                                    onclick="confirmTransferRestore(<?= esc($transfer['id']) ?>)">
