...
<body>
    ...
    <div class="main-container">
            ...
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30">
                    <div class="pd-20 d-flex justify-content-between align-items-center">
                        <h4 class="text-blue h4 mb-0">Online Store Logs</h4>
                        <select id="logFilterDropdown" class="form-control w-auto">
                            <option value="all">Show All</option>
                            <option value="carousels">Carousels</option>
                            <option value="marquees">Marquee Texts</option>
                            <option value="home_collections">Home Collections</option>
                            <option value="carousel2">Carousels 2</option>
                            <option value="logo">Logo</option>
                            <option value="home_image">Home Image</option>
                            <option value="home_blog">Home Blog</option>
                            <option value="blog1">All Blog 1</option>
                            <option value="blog2">All Blog 2</option>
                            ...
                            <option value="email_popup">Email Pop Up</option>
                            <option value="about">About</option>
                            <option value="contact">Contact</option>
                            <option value="cart">Cart</option>
                            <option value="checkout">Checkout</option>
                            <option value="tracking">Tracking</option>
                            <option value="error">404 Page</option>
                ...
                <div id="logSectionsContainer">
                    ...
                    <div class="card-box mb-30 log-section" id="home_collections">
                        <div class="pd-20">
                        ...
                        <div class="pb-20">
                            <table class="table hover data-table-export table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="<?= base_url('home-collection/collection_os_change_logs/' . $item['id']) ?>"
                                                class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="carousel2">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($home_carousel2)): ?>
                                        <?php foreach ($home_carousel2 as $home_carousel): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('Carousel2/Carousel2_history/' . $home_carousel['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="logo">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($home_logos)): ?>
                                        <?php foreach ($home_logos as $home_logo): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('logo/logo_history/' . $home_logo['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="home_image">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($home_images)): ?>
                                        <?php foreach ($home_images as $home_image): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('image/image_history/' . $home_image['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="home_blog">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($home_blogs)): ?>
                                        <?php foreach ($home_blogs as $home_blog): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('home_blog/home_blog_history/' . $home_blog['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="blog1">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($blog_settings)): ?>
                                        <?php foreach ($blog_settings as $blog_setting): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('blog_setting/blog_setting_history/' . $blog_setting['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="blog2">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($onlinestore_blogs)): ?>
                                        <?php foreach ($onlinestore_blogs as $onlinestore_blog): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('onlinestore_blog/onlinestore_blog_history/' . $onlinestore_blog['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="singleblog">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($singleblog_datas)): ?>
                                        <?php foreach ($singleblog_datas as $singleblog_data): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('singleblog_data/singleblog_history/' . $singleblog_data['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="collection">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($os_collections)): ?>
                                        <?php foreach ($os_collections as $os_collection): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('os_collection/os_collection_history/' . $os_collection['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="product">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($product_settings)): ?>
                                        <?php foreach ($product_settings as $product_setting): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('product_setting/product_setting_history/' . $product_setting['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="policy">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($policies)): ?>
                                        <?php foreach ($policies as $policie): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('policie/policie_history/' . $policie['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="footer">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($footer_datas)): ?>
                                        <?php foreach ($footer_datas as $footer_data): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('footer/footer_history/' . $footer_data['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="header">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($header_pages)): ?>
                                        <?php foreach ($header_pages as $header_page): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('header_page/header_page_history/' . $header_page['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="email_popup">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($email_pop_ups)): ?>
                                        <?php foreach ($email_pop_ups as $email_pop_up): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('email_pop_up/email_pop_up_history/' . $email_pop_up['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="about">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($aboutpages)): ?>
                                        <?php foreach ($aboutpages as $aboutpage): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('aboutpage/aboutpage_history/' . $aboutpage['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="contact">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($contactpages)): ?>
                                        <?php foreach ($contactpages as $contactpage): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('contactpage/contactpage_history/' . $contactpage['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="cart">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($cartpages)): ?>
                                        <?php foreach ($cartpages as $cartpage): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('cartpage/cartpage_history/' . $cartpage['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="checkout">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($checkoutpages)): ?>
                                        <?php foreach ($checkoutpages as $checkoutpage): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('checkoutpage/checkoutpage_history/' . $checkoutpage['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="tracking">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($trackingpages)): ?>
                                        <?php foreach ($trackingpages as $trackingpage): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('trackingpage/trackingpage_history/' . $trackingpage['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="error">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($error_pages)): ?>
                                        <?php foreach ($error_pages as $error_page): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('error_page/error_page_history/' . $error_page['id']) ?>"
                                                        class="text-primary">
                    ...
                    <div class="card-box mb-30 log-section" id="team">
                        <div class="pd-20">
                                ...
                                <tbody>
                                    <?php if (!empty($team_members)): ?>
                                        <?php foreach ($team_members as $team_member): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?= base_url('team_members/team_member_history/' . $team_member['id']) ?>"
                                                        class="text-primary">
        ...
        <script>
            document.getElementById('logFilterDropdown').addEventListener('change', function () {
                const selected = this.value;
                const allBlocks = document.querySelectorAll('.log-section');

                allBlocks.forEach(block => {
                    const id = block.id || block.dataset.section;
